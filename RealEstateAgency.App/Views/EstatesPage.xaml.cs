...
namespace RealEstateAgency.App.Views
{
    ...
    /// </summary>
    public sealed partial class EstatesPage : Page, INavigationPage
    {
        ...
        public EstatesPage()
        {
            NavigationPage.Register(this, "NavigateToEstatesPageCommand");
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            NavigationPage.Register(this,
                                    new Core.ViewModels.EstatesViewModel(NavigationService.Instance, canNavigateTo.ToArray()),
                                    e.Parameter);
