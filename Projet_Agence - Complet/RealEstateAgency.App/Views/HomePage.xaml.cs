...
namespace RealEstateAgency.App.Views
{
    ...
    /// </summary>
    public sealed partial class HomePage : Page, INavigationPage
    {
        ...
        public HomePage()
        {
            NavigationPage.Register(this, "NavigateToHomePageCommand");
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            NavigationPage.Register(this, 
                                    new Core.ViewModels.HomeViewModel(NavigationService.Instance, canNavigateTo.ToArray()),
                                    e.Parameter);
